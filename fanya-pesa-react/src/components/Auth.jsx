        ...
        return (
            <div className="min-h-screen bg-gray-50 dark:bg-[#1a1a2e] flex flex-col items-center pt-24 px-6 transition-colors duration-300">
                <div className="max-w-3xl w-full text-center animate-fade-in-up">
                    <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 dark:text-white mb-3">Welcome to Elgen Funding</h2>
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-[#1a1a2e] flex flex-col items-center pt-24 px-6 transition-colors duration-300">
            <div className="w-full max-w-md text-center animate-fade-in-up">
                ...
                <p className="text-gray-500 dark:text-gray-400 mb-8 text-sm">Please choose an authentication method to log into your Elgen Funding account.</p>
