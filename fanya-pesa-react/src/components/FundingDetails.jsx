...
const STATUS_STEPS = [
    ...
    { key: 'Capital Secured', label: 'Capital Secured', icon: '🔐', desc: 'A funder has approved your deal. 30% has been deposited to your supplier.' },
    { key: 'Waybill Uploaded', label: 'Goods Dispatched', icon: '📦', desc: 'Your supplier has uploaded proof of dispatch. 40% payment has been released.' },
    { key: 'Delivery Confirmed', label: 'Delivery Confirmed', icon: '✅', desc: 'You have confirmed receipt of goods. Final 30% payout released. Deal closed.' },
];
